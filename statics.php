    ...
    <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;" data-position="right" class="navbar-default navbar-static-side">
      <div class="sidebar-collapse menu-scroll">
        <ul id="side-menu" class="nav">      
          ...
          <li <?php if (!isset($_GET['status'])) echo "class='active'";?>><a href="statics.php">
            <div class="icon-bg bg-orange"></div><i class="glyphicon glyphicon-cog"></i>
            <span class="menu-title">Reports</span></a>
          </li>
          <li <?php if($_GET['status']=='all') echo "class='active'";?>><a href="statics.php?status=all">
          ...
          <li <?php if($_GET['status']=='open') echo "class='active'";?> ><a href="statics.php?status=open">
          ...
          <li <?php if($_GET['status']=='meeting') echo "class='active'";?>><a href="statics.php?status=meeting">
          ...
          <li <?php if($_GET['status']=='demo') echo "class='active'";?>><a href="statics.php?status=demo">
          ...
          <li <?php if($_GET['status']=='done') echo "class='active'";?>><a href="statics.php?status=done">
          ...
          <li <?php if($_GET['status']=='me_open') echo "class='active'";?>><a href="statics.php?status=me_open">
          ...
          <li <?php if($_GET['status']=='cem_open') echo "class='active'";?>><a href="statics.php?status=cem_open">
            <div class="icon-bg bg-pink"></div><i class="glyphicon glyphicon-search"></i>
            <span class="menu-title">CEM Open</span><?php echo countRequest('cem_open', $type, $user_id, $db_handle); ?></a>   
          </li>
          <li <?php if($_GET['status']=='salary_issue') echo "class='active'";?>><a href="statics.php?status=salary_issue">
          ...
          <li <?php if($_GET['status']=='delete') echo "class='active'";?>><a href="statics.php?status=delete">
          ...
          <li <?php if($_GET['status']=='just_to_know') echo "class='active'";?>><a href="statics.php?status=just_to_know">
          ...
          <li <?php if($_GET['status']=='decay') echo "class='active'";?>><a href="statics.php?status=decay">
          ...
          <li <?php if($_GET['status']=='not_interested') echo "class='active'";?>><a href="statics.php?status=not_interested">
          ...
          <li <?php if($_GET['status']=='followback') echo "class='active'";?>><a href="statics.php?status=followback">
          ...
          <li <?php if($_GET['status']=='feedback') echo "class='active'";?>><a href="statics.php?status=feedback">
            <div class="icon-bg bg-blue"></div><i class="glyphicon glyphicon-repeat"></i>
            <span class="menu-title">Feedback Requests</span><?php echo countRequest('feedback', $type, $user_id, $db_handle); ?></a>
          </li>
          <li <?php if($_GET['status']=='24') echo "class='active'";?>><a href="statics.php?status=24">
