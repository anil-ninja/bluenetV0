...
function validateWorkerDetails(request_id){
...
function addworker(request_id, id){
  if (id == 1){
    worker_modal = "<form class='form-horizontal' id='worker_details_form"+request_id+"' onsubmit='return (validateWorkerDetails("+request_id, id+"));'>" +
                      ...
                      "</div>"+
                    "</form>";
    $("#addworker").show().html(worker_modal);
  }
  else {
    worker_modal = "<form class='form-horizontal' id='worker_details_form"+request_id+"' onsubmit='return (validateWorkerDetails("+request_id, id+"));'>" +
                      "<div class='form-group'>"+
